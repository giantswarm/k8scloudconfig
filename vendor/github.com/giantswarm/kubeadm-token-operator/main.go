...
import (
	...
	"github.com/giantswarm/kubeadm-token-operator/flag"
	"github.com/giantswarm/kubeadm-token-operator/server"
	"github.com/giantswarm/kubeadm-token-operator/service"
)

var (
	description string     = "The kubeadm-token-operator generates tokens for kubeadm."
	f           *flag.Flag = flag.New()
	gitCommit   string     = "n/a"
	name        string     = "kubeadm-token-operator"
	source      string     = "https://github.com/giantswarm/kubeadm-token-operator"
)
